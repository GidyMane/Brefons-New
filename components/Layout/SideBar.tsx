                                        ...
                                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                                            ...
                                            <ul className="mt-2 space-y-1 px-4">
                                                {men?.menuItems?.map((item, index) => (
                                                    <li key={index}>
                                                        <Link href={`/brefons.console/${item.link}`} className={`block rounded-lg px-4 py-2   hover:bg-gray-100 hover:text-green-700 ${path.includes(item.link) ? "text-green-600 text-lg font-bold" : "text-md font-medium text-gray-500 "}`}>
                                                            {item.name}
                                                        </Link>
                                                    </li>
                                                ))}
