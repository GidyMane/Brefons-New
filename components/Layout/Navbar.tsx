...
const NavBar = () => {
  ...
  return (
    <div className='w-full border-b h-14 border-slate-50 fixed inset-x-0 backdrop-blur-lg transition-all bg-white/75 z-40'>
      <div className="max-w-screen-2xl h-14 m-auto w-full px-3 sm:px-8 lg:px-10 xl:px-8 flex items-center justify-between py-4 z-40">
        <div className="flex items-center justify-start gap-1.5">
          <Link href="/" className="flex items-center mb-0 space-x-3 rtl:space-x-reverse">
            ...
            <span className="self-center text-2xl hidden md:flex font-semibold whitespace-nowrap text-gray-900 text-balance uppercase !leading-tight tracking-tight">Brefons</span>
          </Link>
          <HamBurgerButton />
        </div>
        <div className="flex flex-1 items-center justify-end">
          ...
          {/* <div className='md:h-8 md:w-8 rounded-full'>
            <ModeToggle />
          </div> */}

          <div className='md:h-8 md:w-8 rounded-full mx-2 outline-1'>
            <Image src={"/maps.png"} alt='maps' className='h-8 w-8 rounded-full' width={20} height={20}  blurDataURL='https://github.com/shadcn.png' />

          </div>
          <div className='md:h-8 md:w-8 rounded-full outline-1'>
            <Image src={"https://github.com/shadcn.png"} alt='user' className='h-8 w-8 rounded-full' width={20} height={20}  blurDataURL='https://github.com/shadcn.png' />
          </div>
