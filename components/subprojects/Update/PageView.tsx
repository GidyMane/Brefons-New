...
const UpdatePageView = () => {
    ...
    const isEdit = useSelector((state: RootState) => state.subProject.isEditUpdate)
    ...
    useEffect(() => {
        const getContracts = async () => {
          await axios
            ...
            .then((component) => {
             console.log("get contracts ",component?.data?.contracts)
    ...
    return (
        <div>
            <h2 className='my-2 tracking-tight leading-tight text-balance text-xl md:text-2xl dark:text-gray-950 mx-4'> Update Contract</h2>
            ...
            <div className='rounded-md flex flex-col md:flex-row justify-start items-start gap-6 w-full'>
                <div className='md:w-[500px] md:h-[300px] h-auto w-auto overflow-hidden'>
                    <Image src={"/contract.jpg"} width={300} height={300} alt='budget' placeholder='blur' blurDataURL='/contract.jpg' className='border rounded-md w-full' />
                ...
                <div className='flex flex-col gap-4'>
                    <p className='w-auto md:w-[500px] tracking-wide leading-wide text-balance text-muted-foreground'>To update a contract , search for a contract by any column , slide to the right and hit the three dot caret options</p>
                </div>
            </div>
